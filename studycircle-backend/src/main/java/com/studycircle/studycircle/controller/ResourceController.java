...
import com.studycircle.studycircle.exception.ErrorResponse;
import com.studycircle.studycircle.exception.EntityNotFoundException;
...
public class ResourceController {
 ...
 Resource uploadedResource = resourceService.uploadResource(file, userId, sessionId); // Pass sessionId to service
 ...
 @RequestBody Resource updatedResourceDetails,
 Principal principal) {
 Long userId = Long.parseLong(principal.getName()); // Or get user ID from principal
 try {
 Resource updatedResource = resourceService.updateResource(id, updatedResourceDetails, userId);
