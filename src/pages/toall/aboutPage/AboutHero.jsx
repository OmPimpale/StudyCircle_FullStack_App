                ...
                <div className="text-center">
                    ...
                    <div className="md:grid grid-cols-5 gap-10 items-center">
                        ...
                        <div className="col-span-3 mt-5 md:mt-0 md:text-start">
                            ...
                            <p className="text-[20px] text-[#5a5a5a] mb-7">At StudyCircle, we believe that knowledge grows best when it's shared. We’re building a student-powered learning community where anyone can:</p>
                            <Link to="/singUp" className="text-white text-[18px] border-1 border-[#4A90E2] bg-[#4A90E2] py-1.5 px-7 rounded-full">Join Circle <FontAwesomeIcon icon={faStreetView} size="lg" className="text-white" /></Link>
                        </div>
                    </div>
                </div>
            </section>
